...
namespace Agrodit_angular.API.Controllers
{
    ...
    {   ILog log4Net;
        ICompanyusersManager Manager;
        ValidationResult ValidationResult;
        public CompanyusersController(ICompanyusersManager manager)
        {  
			log4Net = this.Log<CompanyusersController>();
            Manager = manager;
        ...
        {try
            ...
            return Ok(Manager.GetCompanyusers(page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
        ...
        {try
            ...
            List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
            return Ok(Manager.SearchCompanyusers(searchKey, page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        {try
            ...
            return Ok(Manager.GetCompanyusersByID(id));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPost]
        [Route(APIEndpoint.DefaultRoute)]
        public ActionResult Post(CompanyusersModel model)
        {try
            {
            return Ok(Manager.AddCompanyusers(model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPut]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Put(int id, CompanyusersModel model)
        {try
            {
			if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
            ...
            return Ok(Manager.UpdateCompanyusers(id, model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPatch]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Patch(int id, [FromBody] JsonPatchDocument<CompanyusersModel> model)
        {
            try
            {
                if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
                ...
                var response = Manager.GetCompanyusersByID(id);
                if (response.code == ResponseCode.SUCCESS)
                {
                    var result = (CompanyusersModel)response.document;
                    model.ApplyTo(result);
                     return Ok(Manager.UpdateCompanyusers(id, result));
                }
        ...
        public ActionResult Delete(int id)
        {
           ...
           return Ok(Manager.DeleteCompanyusers(id));
		   }catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        public ActionResult DeleteMultiple(List<DeleteMultipleModel> deleteParam, string andOr = "AND")
        {
            try
            {
                ...
                return Ok(Manager.DeleteMultipleCompanyusers(deleteParam, andOr.ToUpper()));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
        ...
        public ActionResult Filter(List<FilterModel> filterColumnList,string andOr = "AND", int page = 1, int itemsPerPage = 100, string orderBy = null)
        {
            try
            {
                ...
                List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
                return Ok(Manager.FilterCompanyusers(filterColumnList,andOr, page, itemsPerPage, orderModelList));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
