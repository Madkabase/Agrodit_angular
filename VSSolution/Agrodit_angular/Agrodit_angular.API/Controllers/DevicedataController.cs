...
namespace Agrodit_angular.API.Controllers
{
    ...
    {   ILog log4Net;
        IDevicedataManager Manager;
        ValidationResult ValidationResult;
        public DevicedataController(IDevicedataManager manager)
        {  
			log4Net = this.Log<DevicedataController>();
            Manager = manager;
        ...
        {try
            ...
            return Ok(Manager.GetDevicedata(page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
        ...
        {try
            ...
            List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
            return Ok(Manager.SearchDevicedata(searchKey, page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        {try
            ...
            return Ok(Manager.GetDevicedataByID(id));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPost]
        [Route(APIEndpoint.DefaultRoute)]
        public ActionResult Post(DevicedataModel model)
        {try
            {
            return Ok(Manager.AddDevicedata(model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPut]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Put(int id, DevicedataModel model)
        {try
            {
			if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
            ...
            return Ok(Manager.UpdateDevicedata(id, model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPatch]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Patch(int id, [FromBody] JsonPatchDocument<DevicedataModel> model)
        {
            try
            {
                if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
                ...
                var response = Manager.GetDevicedataByID(id);
                if (response.code == ResponseCode.SUCCESS)
                {
                    var result = (DevicedataModel)response.document;
                    model.ApplyTo(result);
                     return Ok(Manager.UpdateDevicedata(id, result));
                }
        ...
        public ActionResult Delete(int id)
        {
           ...
           return Ok(Manager.DeleteDevicedata(id));
		   }catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        public ActionResult DeleteMultiple(List<DeleteMultipleModel> deleteParam, string andOr = "AND")
        {
            try
            {
                ...
                return Ok(Manager.DeleteMultipleDevicedata(deleteParam, andOr.ToUpper()));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
        ...
        public ActionResult Filter(List<FilterModel> filterColumnList,string andOr = "AND", int page = 1, int itemsPerPage = 100, string orderBy = null)
        {
            try
            {
                ...
                List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
                return Ok(Manager.FilterDevicedata(filterColumnList,andOr, page, itemsPerPage, orderModelList));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
