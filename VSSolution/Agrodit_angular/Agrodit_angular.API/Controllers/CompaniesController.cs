...
namespace Agrodit_angular.API.Controllers
{
    ...
    {   ILog log4Net;
        ICompaniesManager Manager;
        ValidationResult ValidationResult;
        public CompaniesController(ICompaniesManager manager)
        {  
			log4Net = this.Log<CompaniesController>();
            Manager = manager;
        ...
        {try
            ...
            return Ok(Manager.GetCompanies(page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
        ...
        {try
            ...
            List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
            return Ok(Manager.SearchCompanies(searchKey, page, itemsPerPage,orderModelList));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        {try
            ...
            return Ok(Manager.GetCompaniesByID(id));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPost]
        [Route(APIEndpoint.DefaultRoute)]
        public ActionResult Post(CompaniesModel model)
        {try
            {
            return Ok(Manager.AddCompanies(model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPut]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Put(int id, CompaniesModel model)
        {try
            {
			if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
            ...
            return Ok(Manager.UpdateCompanies(id, model));
			}catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        [HttpPatch]
        [Route(APIEndpoint.DefaultRoute + "/{id}")]
        public ActionResult Patch(int id, [FromBody] JsonPatchDocument<CompaniesModel> model)
        {
            try
            {
                if (id <= 0) { ValidationResult.AddEmptyFieldError("id"); }
                ...
                var response = Manager.GetCompaniesByID(id);
                if (response.code == ResponseCode.SUCCESS)
                {
                    var result = (CompaniesModel)response.document;
                    model.ApplyTo(result);
                     return Ok(Manager.UpdateCompanies(id, result));
                }
        ...
        public ActionResult Delete(int id)
        {
           ...
           return Ok(Manager.DeleteCompanies(id));
		   }catch(Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
            }
        ...
        public ActionResult DeleteMultiple(List<DeleteMultipleModel> deleteParam, string andOr = "AND")
        {
            try
            {
                ...
                return Ok(Manager.DeleteMultipleCompanies(deleteParam, andOr.ToUpper()));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
        ...
        public ActionResult Filter(List<FilterModel> filterColumnList,string andOr = "AND", int page = 1, int itemsPerPage = 100, string orderBy = null)
        {
            try
            {
                ...
                List<OrderByModel> orderModelList = UtilityCommon.ConvertStringOrderToOrderModel(orderBy);
                return Ok(Manager.FilterCompanies(filterColumnList,andOr, page, itemsPerPage, orderModelList));
            }
            catch (Exception ex)
            {
                return StatusCode(500, new APIResponse(ResponseCode.ERROR, "Exception", ex.Message));
